package cn.bike.basics.log;

import cn.hutool.core.util.StrUtil;
import cn.hutool.http.useragent.UserAgent;
import cn.hutool.http.useragent.UserAgentUtil;
import cn.bike.basics.redis.RedisTemplateHelper;
import cn.bike.basics.utils.IpInfoUtil;
import cn.bike.basics.utils.ThreadPoolUtil;
...
public class SystemLogAspect {
    ...
    @Pointcut("@annotation(cn.bike.basics.log.SystemLog)")
